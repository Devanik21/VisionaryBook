...
Generated by VisionaryBook - The Image Study Companion
    ...
    def render_history_sidebar(self):
        ...
        with st.sidebar:
            ...
            col1, col2 = st.columns(2)
            with col1:
                if st.button("🆕 New", key="side_new", use_container_width=True, help="Start a new analysis"):
                    st.session_state.current_analysis = None
                    st.session_state.uploaded_image = None
                    st.session_state.study_mode = False
                    st.rerun()
            ...
            with col2:
                if st.button("🏠 Home", key="side_home", use_container_width=True, help="Go to main screen"):
                    st.session_state.study_mode = False
                    st.session_state.qa_mode = False
                    st.rerun()
            ...
            with col_study:
                if st.session_state.current_analysis:
                    if st.button("🎴 Study", key="side_study", use_container_width=True, type="primary"):
                        st.session_state.study_mode = True
                        st.session_state.qa_mode = False
                        st.rerun()
            with col_qa:
            ...
            with st.chat_message("assistant"):
                with st.spinner("The Sage is contemplating..."):
                    try:
                        ...
                        # Add persona and current prompt
                        persona = "You are the Visionary Sage, an unparalleled global authority. You have perfect memory of all images and discussions in this context. Answer the user deeply and wisely."
                        ...
                        st.error(f"The Sage encountered an anomaly: {str(e)}")
