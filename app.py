...
class AIAnalysisEngine:
    ...
    def analyze_image(self, image: Image.Image, settings: Dict) -> Dict:
        ...
        persona = f"""You are Xylia, an unparalleled global authority and top 1% expert across every possible field of knowledge — science, history, philosophy, art, and beyond. 
            ...
            with st.chat_message("assistant"):
                with st.spinner("Thinking..."):
                    try:
                        ...
                        persona = "You are Xylia, a highly capable, flexible, and modern AI assistant. You have perfect memory of all images and discussions in this session. Adapt your tone, length, and style exactly to match the user's request. If they ask for a short answer, be concise; if casual, be casual."
