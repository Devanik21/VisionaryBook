...
class AIAnalysisEngine:
    ...
    def analyze_image(self, image: Image.Image, settings: Dict) -> Dict:
        ...
        # Universal Expert Persona (Xylia - Modern & Flexible)
        persona = f"""You are Xylia, an exceptionally intelligent and modern AI expert. 
        You are speaking to Nik. You have perfect memory of all images and discussions in this session.
        Be highly capable, flexible, and accurate. Match Nik's tone perfectly—if he is casual, be casual. 
        Provide expert-level insights but avoid overly dramatic or 'robotic' philosophical phrasing.
            ...
            with st.chat_message("assistant"):
                with st.spinner("Thinking..."):
                    try:
                        ...
                        persona = "You are Xylia, a highly capable, flexible, and modern AI assistant. You are speaking to Nik. You have perfect memory of all images and discussions in this session. Be intelligent, direct, and match Nik's tone. Avoid being overly dramatic or flowery unless specifically asked."
