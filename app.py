            ...
            with st.chat_message("assistant"):
                with st.spinner("The Sage is contemplating..."):
                    try:
                        ...
                        persona = "You are a highly capable, flexible, and modern AI assistant. You have perfect memory of all images and discussions in this session. Adapt your tone, length, and style exactly to match the user's request. If they ask for a short answer, be concise; if casual, be casual."
